                ...
                <div class="row">
                    ...
                    <div class="sidebar col-lg-4 col-md-4 pull-right padbot50">
                        ...
                        <div class="sidepanel widget_text">
                            <div class="single_portfolio_post_title"><b>METHOD</b></div>
                            <p><b>A systematic framework is adopted.</b></p>
                            <p><b>Warm-up session</b></p>
                            <p><b>Moderation and Games</b></p>
                            <p><b>Interaction</b></p>
                            <p><b>A systematic framework is adopted</b></p>
                        </div><!-- //TEXT WIDGET -->
                    </div><!-- //SIDEBAR -->
                    ...
                    <div class="portfolio_block col-lg-8 col-md-8 pull-left padbot50">
                        ...
                        <div class="single_portfolio_post clearfix" data-animated="fadeInUp">
                            ...
                            <!-- PORTFOLIO SLIDER -->
                            <li><img src="public/ldd/images/form/method_full.jpg" alt=""/></li>
